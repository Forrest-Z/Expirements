...
#Test map 1
  ...
  put_obstacles(
[[10,5,10],[15,5,11],[20,15,20],[25,15,21],[10,25,30],[15,25,31],[30,25,30],[35,25,31],[30,5,10],[35,5,11],[0,0,40],[40,0,41],[22,10,12]],
[[10,10,15],[5,10,15],[5,30,35],[10,30,35],[15,20,25],[20,20,25],[25,10,15],[30,10,15],[25,30,35],[30,30,35],[0,0,40],[40,0,40]],
GRID_TEST)

#Test_map 2
  # put_obstacles([[5,14,18],[10,14,19],[16,22,26],[20,22,27]],
  #   [[14,5,10],[18,5,10],[22,16,20],[26,16,20]],
  #   GRID_TEST)
...
## CALL SEARCH
#Test map 1
search([5,5],goal(32,17),np.pi/2,GRID_TEST,10) 

#Test-map2
#search([5,5],goal(20,30),np.pi/4,GRID_TEST,10) 
